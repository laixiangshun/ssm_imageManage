...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<link rel="${path }/shortcut icon" href="favicon.ico">
	<!-- Google Fonts -->
	...
	<style type="text/css">
		.back{
			...
			display: block;
			opacity: 0.5;
			filter:alpha(Opacity=50);azimuth: -moz-opacity: 0.5;
		}
		.back span{
			margin-top: 10px;
			height: 100px;
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			<figure>
				<img src="${src}" alt="Free HTML5 Bootstrap Template" class="img-responsive">
			</figure>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 text-center">
					<h1 id="fh5co-logo"><a href="${path }/index.html">Magazine <sup>TM</sup></a></h1>
				</div>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry single-entry">
			<article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
				...
				<span class="fh5co-meta animate-box"><a href="single.jsp">Travel</a></span>
				<h2 class="fh5co-article-title animate-box"><a href="single.jsp">My First Time Traveling in Vietnam</a></h2>
				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					...
					<div class="row rp-b">
						<div class="col-lg-6 col-md-12 animate-box">
							<figure>
								<img src="${src }" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
	...
	<div class="back">
		<span><a href="javascript:;" onclick="back();">返回<img alt="back" src="${path }/images/back.png"></a>
		</span>
	</div>
	<footer id="fh5co-footer">
		<p><small>&copy; 2016. Magazine Free HTML5. All Rights Reserverd. <br> More Templates <a href="http://www.cssmoban.com/" target="_blank" title="${username}">${username}</a> - Collect from <a href="http://www.cssmoban.com/" title="${username }" target="_blank">${username}</a></small></p>
	</footer>
